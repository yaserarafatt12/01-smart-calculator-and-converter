...
export const TRANSLATIONS: Record<Language, Translations> = {
  en: {
    ...
    guidebookSubtitle: 'Explore app use cases, scientific modes, 2nd function key, and 14+ unit categories.',
  ...
  id: {
    ...
    guidebookSubtitle: 'Pelajari kegunaan aplikasi, mode ilmiah, fungsi 2nd, dan rincian 14+ kategori satuan.',
